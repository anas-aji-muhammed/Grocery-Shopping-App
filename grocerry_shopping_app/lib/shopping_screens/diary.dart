                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          GestureDetector(
                            child: BuildDiaryCard("Milk", "₹100" , "assets/images/diary/milk.png"),
                          ),
                    ...
                    Expanded(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          new BuildDiaryCard("Butter", "₹100" , "assets/images/diary/butter.png"),
...
class BuildDiaryCard extends StatelessWidget {
  String name, price, asset;
  BuildDiaryCard(String name, String price, String asset){
    this.name = name;
    this.price = price;
    this.asset = asset;
