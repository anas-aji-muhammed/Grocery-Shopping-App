                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          GestureDetector(
                            child: BuildVegeyableCard("Cauliflower", "₹100" , "assets/images/vegetables/cauliflower.png"),
                          ),
                          SizedBox(height: 10,),
                          GestureDetector(
                            child: BuildVegeyableCard("Cabbage", "₹70" , "assets/images/vegetables/cabbage.png"),
                          ),
                          SizedBox(height: 10,),

                          new BuildVegeyableCard("Carrot", "₹40" , "assets/images/vegetables/carrot.png"),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          new OfferWidget(),
                          SizedBox(height: 10,),
                          new BuildVegeyableCard("Pepper", "₹150" , "assets/images/vegetables/pepper.png"),
                          SizedBox(height: 10,),

                          new BuildVegeyableCard("Potato", "₹100" , "assets/images/vegetables/potato.png"),
...
class BuildVegeyableCard extends StatelessWidget {
  String name, price, asset;
  BuildVegeyableCard(String name, String price, String asset){
    this.name = name;
    this.price = price;
    this.asset = asset;
